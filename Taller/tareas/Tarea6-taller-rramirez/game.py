...
#------------------añadi-----------------------
fondo = pygame.image.load("Campodemedusas.png").convert_alpha()
...
for i in range(25):
    ...
    bloque = Bloque(NEGRO, 20, 15,"bob-medusas.png")
...
protagonista = Protagonista(ROJO, 20, 15,"Bob-esponja.png")
...
def message_to_screen(msg,color):
    ...
    pantalla.blit(screen_text,[75,100])
...
while not hecho:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            hecho = True
            print ("FIN DEL JUEGO")
            print ("Obtuvo",puntuacion, "medusas")
    ...
    pygame.display.flip()
x="Fin del juego, Obtuvo: %d medusas" % puntuacion
message_to_screen( x ,ROJO)
pygame.display.flip()
time.sleep(2)
pygame.quit()
