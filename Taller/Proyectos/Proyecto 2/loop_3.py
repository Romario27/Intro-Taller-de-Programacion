...
class Escenario(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.fondo = pygame.image.load("pista3.png").convert_alpha()
        self.menu = pygame.image.load("fondo menu.png").convert_alpha()


        self.final= False
        self.r1=pygame.Rect(0,0,600,600)
        self.r2=pygame.Rect(92,110,50,390)
        self.r3=pygame.Rect(92,485,418,15)
        self.r4=pygame.Rect(510,103,4,397)
        self.r5=pygame.Rect(345,103,163,60)
        self.r6=pygame.Rect(234,0,6,380)
        self.r7=pygame.Rect(234,267,182,113)
        self.meta= pygame.Rect(145,270,90,0.01)
...
def jugar_2():
    ...
    enemigo=oponente(170,280,"opo2.png")
    listaenemigo.append(enemigo)
    enemigo1=oponente(170,330,"opo1.png")
    ...
    while not salir:
        ...
        pygame.draw.rect(escenario.pantalla,BLANCO, escenario.r4)
        pygame.draw.rect(escenario.pantalla,BLANCO, escenario.r5)
        pygame.draw.rect(escenario.pantalla,BLANCO, escenario.r6)
        pygame.draw.rect(escenario.pantalla,BLANCO, escenario.r7)
        ...
        if segundos!=0:
            if protagonista.rect.colliderect(escenario.r1):
        ...
        if segundos!=0:
            if (protagonista.rect.colliderect(escenario.r2) or protagonista.rect.colliderect(escenario.r5) or 
                protagonista.rect.colliderect(escenario.r7)):
                protagonista.velocidad=2
                protagonista.puntuacion-=1
            elif (protagonista.rect.colliderect(escenario.r3) or protagonista.rect.colliderect(escenario.r4) or 
                protagonista.rect.colliderect(escenario.r6)):
                protagonista.velocidad=0.1
                protagonista.puntuacion-=2
            else:
                protagonista.velocidad=5

        if segundos!=0:
            if (protagonista1.rect.colliderect(escenario.r2) or protagonista1.rect.colliderect(escenario.r5) or 
                protagonista1.rect.colliderect(escenario.r7)):
                protagonista1.velocidad=2
                protagonista1.puntuacion-=1
            elif (protagonista1.rect.colliderect(escenario.r3) or protagonista1.rect.colliderect(escenario.r4) or 
                protagonista1.rect.colliderect(escenario.r6)):
                protagonista1.velocidad=0.1
                protagonista1.puntuacion-=2
            else:
