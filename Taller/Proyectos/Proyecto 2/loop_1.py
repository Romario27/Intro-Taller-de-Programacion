...
import threading, json , time, loop_2
...
class Escenario(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.fondo = pygame.image.load("pista1.png").convert_alpha()


        self.final= False
        self.r1=pygame.Rect(98,98,405,408)
        self.r2=pygame.Rect(0,0,600,600)
        self.meta= pygame.Rect(158,510,0.01,100)
...
def jugar_2():
    ...
    escenario=Escenario()
    global direccion, direccion1
    protagonista=jugador(100,525,"carro.png")
    protagonista1=jugador(30,525,"opo2.png")
    enemigo=oponente(100,565,"opo2.png")
    listaenemigo.append(enemigo)
    enemigo1=oponente(30,565,"opo1.png")
    listaenemigo.append(enemigo1)
    pygame.mixer.music.load("Van Halen - Jump.mp3")
    ...
    while not salir:
        ...
        if segundos!=0:
            if protagonista1.rect.colliderect(escenario.r1):
...
##                                    protagonista.listaDisparo.remove(x)
        ...
        if minutos==0 and segundos==00:
            escenario.mensaje("NIVEL 2",ROJO,0,tamaño="grande")
